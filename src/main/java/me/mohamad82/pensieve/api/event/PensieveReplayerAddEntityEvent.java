...
public class PensieveReplayerAddEntityEvent extends Event implements Cancellable {
    ...
    public PensieveReplayerAddEntityEvent(Replayer replayer, PlayBackControl playBackControl, int tickIndex, EntityRecord record) {
