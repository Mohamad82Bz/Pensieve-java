...
public abstract class NPCOld {
    ...
    public void look(float yaw, float pitch) {
        Object packetPlayOutEntityHeadRotation = PacketUtils.getPacketPlayOutEntityHeadRotation(id, yaw);
        Object packetPlayOutEntityLook = PacketUtils.getEntityRotPacket(id, yaw, pitch);
    ...
    public boolean move(double x, double y, double z) {
        ...
        Object packetPlayOutRelEntityMove = PacketUtils.getEntityPosPacket(id, x, y, z);
    ...
    public boolean moveAndLook(double x, double y, double z, float yaw, float pitch, boolean onGround) {
        ...
        Object packetPlayOutEntityHeadRotation = PacketUtils.getPacketPlayOutEntityHeadRotation(id, yaw);
        Object packetPlayOutRelEntityMoveLook = PacketUtils.getEntityPosRotPacket(id, x, y, z, yaw, pitch, onGround);
    ...
    public void teleport(double x, double y, double z, float yaw, float pitch, boolean onGround, Player... players) {
        Object packetPlayOutEntityTeleport = PacketUtils.getPacketPlayOutEntityTeleport(id, x, y, z, yaw, pitch, onGround);
    ...
    public void velocity(double x, double y, double z) {
        Object packetPlayOutEntityVelocity = PacketUtils.getEntityVelocityPacket(id, x, y, z);
    ...
    public void setEquipment(EquipmentSlot slot, ItemStack item) {
        Object packetPlayOutEntityEquipment = PacketUtils.getEntityEquipmentPacket(id, null, item);
    ...
    protected void collect(int collectedEntityId, int collectorEntityId, int amount) {
        Object packetPlayOutCollect = PacketUtils.getCollectItemPacket(collectedEntityId, collectorEntityId, amount);
    ...
    public void setState(NPCState npcState) {
        Object packetPlayOutEntityMetadata = PacketUtils.getPacketPlayOutEntityMetadata(id, npcState);
    ...
    public void setMetadata(int metadataId, Object value, Player... viewers) {
        Object packetPlayOutEntityMetadata = PacketUtils.getPacketPlayOutEntityMetadata(id, metadataId, value);
